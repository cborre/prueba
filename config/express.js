...
module.exports = function () {
	...
	// Usar la variable 'NODE_ENV' para activar los middleware  'morgan'
	...
	require('../app/routes/sedes.server.routes.js')(app);	
	require('../app/routes/clientes.server.routes.js')(app);	
	require('../app/routes/productos.server.routes.js')(app);	
